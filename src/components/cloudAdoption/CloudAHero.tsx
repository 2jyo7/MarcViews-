    ...
    <div className="relative w-full overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-gray-800 dark:text-white space-y-4">
            ...
            <p className="leading-relaxed">
              ...
              business, allowing you to focus on everything else. We specialize
              in:
            </p>
            ...
            <p className="leading-relaxed">
              ...
              approach to migration, leveraging automation and Generative AI at
              every phase to assist in your journey.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 text-center ">
          ...
          <p className="text-gray-700 mt-4 max-w-2xl mx-auto dark:text-white">
