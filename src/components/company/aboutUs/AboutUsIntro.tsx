      ...
      <PopUpEffect>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto mt-4">
            ...
            strengths, redundancies, and gaps in your security posture. Through
            our comprehensive cyber threat and resilience assessments, we
            identify unsecure endpoints, patch exposed devices, standardize
            threat management, and assess exposure to major security threats,
            giving you peace of mind and a plan for success.
          </p>
