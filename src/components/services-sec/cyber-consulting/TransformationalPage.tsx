...
const TransformationalPage = () => {
  const TransformOutcomesData: TransformOutcomeType[] = [
    ...
    },
    {
      ...
      btnName: "Learn More",
      hrefUrl: "/enterprise-risk-management",
      imgUrl:
    ...
    },
    {
      ...
      btnName: "Get Started",
      hrefUrl: "#cyber-strategic-planning",
      imgUrl:
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 py-4">
        {TransformOutcomesData.map(
          ({ id, title, para, btnName, imgUrl, hrefUrl }) => (
            <div
              key={id}
              className="bg-white shadow-lg rounded-lg overflow-hidden transition-transform duration-300 transform
             hover:scale-105 hover:shadow-xl flex flex-col justify-center items-center"
            >
              ...
              <div className="p-4 flex flex-col flex-grow ">
                ...
                <p className="text-gray-600 mt-2 flex-grow py-4">{para}</p>
                {btnName && <Button label={btnName} href={hrefUrl} />}
              </div>
            </div>
          )
        )}
