          ...
          <div className="flex flex-col md:flex-row items-center gap-8 p-6 bg-gray-100 rounded-xl shadow-md">
            ...
            <div className="w-full md:w-1/3 text-center md:text-left">
              ...
              <p className="text-gray-700/90 text-lg text-start">
                Our cybersecurity package offers comprehensive protection
                against evolving digital threats. With layered security
                measures, continuous monitoring, and rapid incident response, we
                ensure a resilient digital environment, minimizing the risk of
                breaches, data loss, and more.
              </p>
            </div>
          </div>
        </div>
