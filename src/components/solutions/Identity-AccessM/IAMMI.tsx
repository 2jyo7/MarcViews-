        ...
        <div className="bg-white shadow-lg rounded-2xl p-8 md:p-12">
          ...
          <div className="space-y-6 text-gray-700">
            <div className="text-lg leading-relaxed">
              <p className="mb-4">
                <span className="font-semibold text-gray-900">Secure Your Digital Identity:</span>  
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">A Unified IAM Service:</h3>
